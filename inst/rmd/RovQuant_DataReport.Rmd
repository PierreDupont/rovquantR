...
```{r}
#| NGS_maps, echo = F, fig.align = "center", fig.height = 8, fig.width = 12,
#| fig.cap = paste0("Annual distributions of " , species, 
#| " non-invasive genetic samples collected between ", years[1], 
#| " and ", years[length(years)], " as used in the OPSCR analysis.”)
