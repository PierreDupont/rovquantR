...
#' @param quantiles a numeric vector of length 2 denoting the boundaries of the credible interval (e.g. c(0.025,0.975), the default value for the 95% credible interval).
#' 
