...
#'
#' The \code{dbinomLocal_normalCovsResponse2} distribution is a NIMBLE custom 
...
#'
#' The \code{dbinomLocal_normalCovsResponse2} distribution incorporates three 
...
#' }
#' 
#' The \code{dbinomLocal_normalCovsResponse2} distribution requires x- and y- 
...
#' 
#' 
#' @name dbinomLocal_normalCovsResponse2
#'
...
#' @rdname dbinomLocal_normalCovsResponse2
#' @export
dbinomLocal_normalCovsResponse2 <- nimbleFunction(
...
#' @rdname dbinomLocal_normalCovsResponse2
#' @export
rbinomLocal_normalCovsResponse2 <- nimbleFunction(
  run = function( n = double(0, default = 1),
    ...
    ##-- Initial checks
    if(detNums >= 0) stop("Random generation for the dbinomLocal_normalCovsResponse2 distribution is not currently supported without combining all individual detections information in one vector. See 'getSparseY()'")
    if(n!=1){print("dbinomLocal_normalCovsResponse2 only allows n = 1; using n = 1")}
