...
```{r, abundance, include=TRUE, fig.align="center", fig.cap=c("Figure 2: Total (black) and sex-specific (blue: males, red: females) annual bear population size estimates"), eval=FALSE}
knitr::include_graphics(file.path(working_dir, "figures/Abundance_TimeSeries.pdf"))
```
...
```{r, density, fig.align="center", fig.cap=c("Brown bear density in Norway in 2023. Density was estimated with an open-population spatial-capture recapture model fitted to NGS and dead recovery data collected between 2020 and 2023"), echo=FALSE}
panel.upr <-  image_read_pdf(file.path(working_dir, "figures/UD_DensityMaps_LastYear.pdf"))
plot(panel.upr)
```
