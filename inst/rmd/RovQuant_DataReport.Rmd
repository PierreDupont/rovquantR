...
#load(file.path(working.dir, "data/Habitat.RData"))
load(file.path( working.dir, "data",
...
The prepared habitat characteristics are available in : `r file.path(working.dir, "data/Habitat.RData")`
...
#load(file.path(working.dir, "data/Detectors.RData"))
load(file.path( working.dir, "data",
