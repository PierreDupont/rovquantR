...
-   `r samples["Total","Total"]` DNA samples collected between `r years[1]` and `r years[length(years)]` (`r samples["Hunn","Total"]` female ; `r samples["Hann","Total"]` male).
...
-   `r ids["Total","Total"]` individuals identified from those DNA samples (`r ids["Hunn","Total"]` female ; `r ids["Hann","Total"]` male).
...
alive$Country_sf[!is.na(as.numeric(st_intersects(alive, COUNTRIES[COUNTRIES$ISO %in% "NOR", ])))] <- "NOR"
alive$Country_sf[!is.na(as.numeric(st_intersects(alive, COUNTRIES[COUNTRIES$ISO %in% "NOR", ])))] <- "SWE"
...
dead.recovery$Country_sf[!is.na(as.numeric(st_intersects(dead.recovery, COUNTRIES[COUNTRIES$ISO %in% "NOR", ])))] <- "NOR"
dead.recovery$Country_sf[!is.na(as.numeric(st_intersects(dead.recovery, COUNTRIES[COUNTRIES$ISO %in% "SWE", ])))] <- "SWE"
