...
\subsection{Non-invasive genetic samples and dead recoveries}
\noindent
A total of \numprint{5864} (\numprint{2423} female; \numprint{3441} male) genotyped bear genetic samples collected in Norway between 2014 and 2023 were included in the analysis (\autoref{fig:AnnualNGmaps}). These samples were associated with \numprint{592} (208 female; 384 male) individuals. We also included 134 bears recovered dead in Norway or at the border area with Sweden in the OPSCR model, of which 115 (28 female; 87 male) were due to legal culling and 19 (7 female; 12 male) due to other causes of mortality. Annual tallies of NGS samples and associated individuals, as well as dead recoveries included in the analysis for the period 2014-2023 are provided in the Appendices (NGS samples and individuals: \autoref{tab:NGSbear}, dead recoveries: \autoref{tab:Deadbear}).\\
