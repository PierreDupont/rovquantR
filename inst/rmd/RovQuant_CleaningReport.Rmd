...
```{r, NGS previously detected, fig.align = "center", fig.cap = paste0("Figure 3: A) Numbers of ", species, " individuals detected through non-invasive genetic sampling, and B) Numbers of ", species, " individuals recovered dead that were previously detected through NGS per year between ", years[1], " and ", years[length(years)], "."), echo = FALSE}
knitr::include_graphics(file.path( working.dir, "figures",
...
Finally, we save the cleaned **alive** and **dead.recovery** sf objects as a .RData file with name **`r fileName`** located in the `r species`-specific folder (`r file.path(working.dir, "data")`).
