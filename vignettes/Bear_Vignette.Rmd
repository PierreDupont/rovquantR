...
<img src="inst/images/RovQuant.png" align="center" height="180"/></a>
...
```{r nimbleSCR2, echo = FALSE, eval = FALSE}
library(nimbleSCR)
```
...
```{r set-up1.2, eval = FALSE, echo = FALSE}
...
```{r set-up2.2, eval = FALSE, echo = FALSE}
