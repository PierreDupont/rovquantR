...
#' @keywords datasets
#' 
#' @format ## `COUNTRIESWaterHumans`
#' A Simple feature collection with 56 features and 10 fields
#' @source <https://www.nmbu.no/en/research/projects/rovquant>
#' @examples
#' data(COUNTRIESWaterHumans)
"COUNTRIESWaterHumans"
NULL
...
#' 
#' @format ## `GLOBALMAP`
#' A Simple feature collection with 239 features and 4 fields
#' @source <https://www.nmbu.no/en/research/projects/rovquant>
#' @examples
#' data(GLOBALMAP)
"GLOBALMAP"
...
#' @keywords datasets
#' 
#' @format ## `habitatRasterResolution`
#' A list of RasterStacks 
#' @source <https://www.nmbu.no/en/research/projects/rovquant>
#' @examples
