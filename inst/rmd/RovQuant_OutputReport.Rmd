...
```{r, FigS1, fig.align = "center", fig.cap = paste0("Figure 3: ", species, " density in Norway between ", years[1], " and ", years[length(years)], "."), echo = FALSE}
knitr::include_graphics(file.path(working.dir, "figures/UD_Density_TimeSeries.png"))
```
